...
public class DelController implements IBack {
    ...
    public void action(HttpServletRequest request, HttpServletResponse response) {
        ...
        data[1] = ((String) request.getParameter("inSurnameHid")).trim();
        data[2] = ((String) request.getParameter("inNameHid")).trim();
        data[3] = ((String) request.getParameter("inMiddleNameHid")).trim();
        data[4] = ((String) request.getParameter("inCountHid")).trim();
