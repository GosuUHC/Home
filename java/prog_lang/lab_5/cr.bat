...
javac --module-path Libs\javafx\lib --add-modules=javafx.controls,javafx.fxml -classpath . -d . UpdateController.java
javac --module-path Libs\javafx\lib --add-modules=javafx.controls,javafx.fxml -classpath . -d . InsertController.java
